...
public class partialLinkText {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//We take webdriver instead of chromedriver because security purpose because chromedriver is class so class can be changed by anyone but if take interface instead of class it is not possible to chnaged.
